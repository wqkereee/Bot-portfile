...
....
/update_projects Обновить ваш проект 
....
/projects Ваши проекты
....
/status 1 На этапе проектирования 
        2 В процессе разработки
        3 Разработан. Готов к использованию.
        4 Обновлен
        5 Обновлен Завершен. Не поддерживается
....
/skill  Вы можете сюда вести языки, которые использовали для разработки.
....
